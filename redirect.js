    ...
    const products = {
        'mimax': {
            ...
            info: {
                ...
                health: 'Омоложение, Противовоспалительное средство, Повышает иммунитет, Повышает уровень энергии, Улучшает пищеварение, Регулирует уровень холестерина и глюкозы в крови, Защита и улучшение зрения, Укрепление функции сердца и печени, Уменьшает повреждение ДНК, Улучшает метаболизм, Устраняет симптомы усталости глаз, Улучшает состояние кожи, Снижает эректильную дисфункцию, Защита желудочно-кишечной функции, Анти-старение и окисление.',
